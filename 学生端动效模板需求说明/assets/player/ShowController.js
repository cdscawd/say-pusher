...
var ShowController = Class.create({
    ...
    handleClickEvent: function(b) {
        console.log(' handleClickEvent() 工作区 click ')
        if (this.isRecording) {
            return
        }
        var a, d;
    ...
    onKeyPress: function(c, a) {
        ...
        case kKeyCode_Escape:
            ...
            break;
        case kKeyCode_Slash:
        case kKeyCode_Slash + kKeyModifier_Shift: if (this.helpPlacard.isShowing) {
                this.helpPlacard.hide()
            } else {
        ...
        case kKeyCode_PageDown:
            ...
            break;
        case kKeyCode_RightArrow + kKeyModifier_Shift: case kKeyCode_CloseBracket:
            this.advanceAndSkipBuild("onKeyPress");
            break;
        case kKeyCode_DownArrow + kKeyModifier_Shift: case kKeyCode_PageDown + kKeyModifier_Shift: case kKeyCode_CloseBracket:
        case kKeyCode_Equal + kKeyModifier_Shift: case kKeyCode_Equal:
        case kKeyCode_Plus:
        ...
        case kKeyCode_UpArrow + kKeyModifier_Shift: case kKeyCode_Hyphen:
        case kKeyCode_Minus:
    ...
    toggleFullscreen: function() {
        ...
        if (document.webkitIsFullScreen || document.mozFullScreen) {
            this.isFullscreen = false; (document.webkitCancelFullScreen && document.webkitCancelFullScreen()) || (document.mozCancelFullScreen && document.mozCancelFullScreen())
        } else {
            this.isFullscreen = true; (document.body.webkitRequestFullScreen && document.body.webkitRequestFullScreen()) || (document.body.mozRequestFullScreen && document.body.mozRequestFullScreen())
        }
    },
    ...
    jumpToScene_partFour: function(f, e) {
        ...
        if (e) {
            ...
            if (a.showMode === kShowModeAutoplay) {
                ...
                var c = d.effects;
                if (c && c.length > 0) {
                    var b = c[0].type === "transition" ? a.autoplayTransitionDelay: a.autoplayBuildDelay;
                    setTimeout((function() {
                        this.playCurrentScene()
                    }).bind(this), b * 1000)
                } else {
    ...
    currentSceneDidComplete: function(c) {
        ...
        if (d == kShowModeHyperlinksOnly || (c != -1 && c != this.nextSceneIndex)) {
            ...
            if (this.nextSceneIndex === -1) {
                ...
                if (b.events[this.nextSceneIndex].automaticPlay || d === kShowModeAutoplay) {
